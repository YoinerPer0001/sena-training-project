    ...
    return (
        <main className={styles.main}>
            <section className={styles.section_main}>
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-white lg:text-[#00324D]">Inicio de sesión</h2>
                <form className="flex flex-col w-3/4 sm:w-2/4" onSubmit={onSubmit}>
                    ...
                    {errors.Ema_User && <DangerMessage>{errors.Ema_User.message}</DangerMessage>}
                    <div className="mt-2">
                        <button type="submit" className="inline-block bg-[#39A900] lg:text-white lg:bg-[#00324D] text-white  py-2 px-3 rounded-xl text-base sm:text-xl font-semibold hover:bg-black transition-all duration-200 cursor-pointer">Iniciar sesión</button>
                    </div>
                </form>
                {/* Olvidó su contraseña? */}
                <div className="flex w-full justify-center flex-col sm:flex-row items-center">
                    <div className="mx-5">
                        <Link href="" className="underline text-sm sm:text-base text-white lg:text-[#00324D] hover:font-semibold hover:text-black">¿Olvidó su contraseña?</Link>
                    </div>
                </div>
