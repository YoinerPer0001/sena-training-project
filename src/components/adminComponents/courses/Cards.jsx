            ...
            {/* {cards} */}
            {
                !isLoading ? (
                    <div className={`w-full grid lg:gap-4 2xl:gap-0 px-2 my-2  lg:grid-flow-col sm:grid-flow-row justify-around h-auto `}>
                        <div class='p-4 flex flex-col rounded-md  min-h-32 w-64 shadow-md text-white bg-gradient-to-r from-[#FF5774] to-[#FF8398] '>
                        ...
                        <div class='p-4 flex my-2 rounded-md flex-col text-white min-h-32 w-64 shadow-md  bg-gradient-to-r from-[#FFB751] to-[#FFCA7D] '>
                        ...
                        <div class='p-4 flex my-2 rounded-md flex-col text-white min-h-32 w-64 shadow-md  bg-gradient-to-r from-[#56DFC4] to-[#56DFC4] '>
                        ...
                        <div class=' p-4 my-2 rounded-md flex flex-col text-white min-h-32 w-64 shadow-md  bg-gradient-to-r from-[#4b9fffbb] to-[#71b3ffbe] '>
