...
export const Cards = ({ id }) => {
    ...
    return (
        <>
            ...
            {
                !isLoading ? (
                    <div className={`w-full grid gap-4 px-2   lg:grid-flow-col sm:grid-flow-row justify-around h-auto `}>
                        ...
                        <div class='p-4 flex flex-col text-white min-h-32 w-64 shadow-md  bg-gradient-to-r from-[#FFB751] to-[#FFCA7D] '>
                        ...
                        <div class='p-4 flex flex-col text-white min-h-32 w-64 shadow-md  bg-gradient-to-r from-[#56DFC4] to-[#56DFC4] '>
                        ...
                        <div class=' p-4 flex flex-col text-white min-h-32 w-64 shadow-md  bg-gradient-to-r from-[#4b9fffbb] to-[#71b3ffbe] '>
