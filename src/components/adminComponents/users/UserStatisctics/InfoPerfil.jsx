        ...
        <>
            ...
            {!isLoading ? (
                <div className={`${styles.contDerecho} flex-col w-1/3 ml-1 bg-slate-100 flex p-2`}>
                    <div className='w-full p-4 bg-white flex  h-auto shadow-md bg-gradient-to-r from-azulSena to-[#1C4860]'>
                    ...
                    <div className={`p-4 w-full flex-wrap gap-4 bg-white h-full mt-1 shadow-md `}>
