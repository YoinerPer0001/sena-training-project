    ...
    return (
        <div className={styles.aside}>
            <ul>
                ...
                <li><a href="/admin/profile#ultimoCurso" className={`items-center justify-start ${pathname.includes('/courses/mycourses') ? styles.active : ''}`}><BookCheck /> <p>Mis cursos</p></a></li>
